odoo.define('ye_dynamic_odoo.BaseEdit', function (require) {
"use strict";
    ...
    var PropertyBase = Widget.extend({
        ...
        start: function () {
            ...
            view.form.tree = ["showInvisible", "create", "delete", "string", "color", "more"];
            ...
            view.tree.tree = ["showInvisible", "create", "delete", "editable", "string", "color"];
